...
const Contact = () => {
 ...
 const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "e377b7f4-1437-49fd-a4ab-5504e6f5ea55");
...
Your Email
<input className = "w-full border border-gray-300 rounded py-3 px-4 mt-2" type = "email" name = "Email" placeholder = "enter mail"  required/>
</div>

    </div>


<div className = "mt-4 my-6 text-left">
